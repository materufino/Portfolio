...
const Proyectos = [
    ...
    },
    {
        ...
        imagen: anforas,
        descripcion: "Primera versión web para la empresa donde cuentan su historia, exhiben sus productos y enseñan su galeria de fotos.",
        descripcionCompleta: "Primer version del sitio web para Ánforas de Atenea, donde el objetivo principal es mostrar sus productos y su galeria de imagenes de las instalaciones de la empresa.",
        tecnologias: ["react"]
    },
    {
